#ifndef __INTERFLOP_VECTOR_IEEE_SCALAR_H__
#define __INTERFLOP_VECTOR_IEEE_SCALAR_H__

#define INTERFLOP_VECTOR_IEEE_API(name) interflop_vector_ieee_##name##_##scalar
